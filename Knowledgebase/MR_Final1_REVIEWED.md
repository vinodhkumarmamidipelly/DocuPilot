...
- Permissions:
  - Add/Customize Pages (for SPFx panel, if used)
...
- Permissions:
  ...
  - (Optional) Create Copilot Agent with instructions
...
|---------|--------|----------|
| DOCX Only | Enriched DOCX | Best Copilot search results |
| PDF Only | Enriched PDF | Best distribution format |
| Both | DOCX + PDF | Balanced (DOCX for Copilot + PDF for users) |

**Recommendation:** DOCX for best Copilot search effectiveness (main goal).
...
**Logic:**
- If identical content/hash → Skip processing
...
All 8 questions answered with clear, architect-level explanations covering:
- ✅ File size restrictions (50MB)
- ✅ Permissions at 5 levels
- ✅ OpenXML capabilities + enhancement approach
- ✅ Multiple upload handling
- ✅ Output format (DOCX recommended)
- ✅ Source document retention
- ✅ Mid-processing failure handling
- ✅ Duplicate vs versioning logic

**Key Principles:**
- Reliability through error handling and retry mechanisms
- Efficiency through duplicate detection and smart versioning
- Data safety through source document preservation
- Current content through version reprocessing
- Copilot optimization through format and structure choices
