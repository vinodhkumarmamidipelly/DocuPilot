...
var WebPartDataConverter = /** @class */ (function () {
    ...
    WebPartDataConverter.convertServerProcessedDataToHtml = function (serverContent) {
        ...
        if (serverContent) {
            if (serverContent.htmlStrings) {
                result += WebPartDataConverter._convertServerProcessedDataToHtmlByType(serverContent.htmlStrings, 1 /* ServerProcessedDataType.htmlString */);
            }
            if (serverContent.searchablePlainTexts) {
                result += WebPartDataConverter._convertServerProcessedDataToHtmlByType(serverContent.searchablePlainTexts, 4 /* ServerProcessedDataType.searchablePlainText */);
            }
            if (serverContent.links) {
                result += WebPartDataConverter._convertServerProcessedDataToHtmlByType(serverContent.links, 2 /* ServerProcessedDataType.link */);
            }
            if (serverContent.imageSources) {
                result += WebPartDataConverter._convertServerProcessedDataToHtmlByType(serverContent.imageSources, 3 /* ServerProcessedDataType.imageSource */);
            }
        }
        return result;
    };
    ...
    WebPartDataConverter._getHtmlString = function (propName, propType, propValue) {
        ...
        if (propName && typeof propValue === 'string' && propValue) {
            switch (propType) {
                case 1 /* ServerProcessedDataType.htmlString */:
                    ...
                    break;
                case 4 /* ServerProcessedDataType.searchablePlainText */:
                    ...
                    break;
                case 2 /* ServerProcessedDataType.link */:
                    ...
                    break;
                case 3 /* ServerProcessedDataType.imageSource */:
