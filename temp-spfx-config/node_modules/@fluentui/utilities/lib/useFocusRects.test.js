...
describe('useFocusRects', function () {
    ...
    describe('when attaching the classnames to the window body', function () {
        it('can hint to show focus when you press a directional key', function () {
            act(function () {
                focusRects1 = render(React.createElement(FocusRects, { rootRef: mockRefObject }));
                focusRects2 = render(React.createElement(FocusRects, { rootRef: mockRefObject }));
            });
        ...
        it('can hint to show focus when you press a directional key with multi-window', function () {
            act(function () {
                focusRects1 = render(React.createElement(FocusRects, { rootRef: mockRefObject }));
                focusRects2 = render(React.createElement(FocusRects, { rootRef: mockRefObject2 }));
            });
        ...
        it('can disable focus rects', function () {
            ...
            var component;
            act(function () {
                component = render(React.createElement(FocusRects, { rootRef: mockRefObject }));
            });
            var eventListeners = mockWindow.eventListeners;
    ...
    describe('when attaching the classnames to the a provider element', function () {
        ...
        it('can hint to show focus when you press a directional key', function () {
            ...
            act(function () {
                focusRects1 = render(React.createElement(FocusRectsWithProvider, { providerRef: providerRef, rootRef: mockRefObject }));
            });
        ...
        it('can disable focus rects', function () {
            ...
            var component;
            act(function () {
                component = render(React.createElement(FocusRectsWithProvider, { providerRef: providerRef, rootRef: mockRefObject }));
            });
            var providerElem = providerRef.current;
            var eventListeners = providerElem.eventListeners;
            expect(eventListeners.keyup).toBeUndefined();
