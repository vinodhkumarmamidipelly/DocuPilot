define(["require", "exports", "tslib", "react", "@fluentui/merge-styles", "./shadowDom/index", "./customizations/useCustomizationSettings"], function (require, exports, tslib_1, React, merge_styles_1, index_1, useCustomizationSettings_1) {
    "use strict";
    ...
    function styled(Component, baseStyles, getProps, customizable, pure) {
        ...
        var Wrapped = React.forwardRef(function (props, forwardedRef) {
            ...
            var useStyled = (0, index_1.useMergeStylesHooks)().useStyled;
