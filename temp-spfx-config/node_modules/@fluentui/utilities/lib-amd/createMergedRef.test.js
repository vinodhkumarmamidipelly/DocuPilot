define(["require", "exports", "tslib", "react", "./createMergedRef", "@testing-library/react"], function (require, exports, tslib_1, React, createMergedRef_1, react_1) {
    "use strict";
    ...
    describe('createMergedRef', function () {
        it('can merge refs', function () {
            ...
            var wrapper = (0, react_1.render)(React.createElement(Foo, { domRef: ref2 }));
