define(["require", "exports", "tslib", "react", "@testing-library/react", "./extendComponent"], function (require, exports, tslib_1, React, react_1, extendComponent_1) {
    "use strict";
    ...
    describe('extendComponent', function () {
        it('can extend a component with custom lifetime methods', function () {
            ...
            var component = (0, react_1.render)(React.createElement(Foo, null));
            component.unmount();
