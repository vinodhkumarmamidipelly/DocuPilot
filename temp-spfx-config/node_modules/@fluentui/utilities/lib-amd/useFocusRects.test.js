define(["require", "exports", "react", "@testing-library/react", "./useFocusRects", "./FocusRectsProvider", "./setFocusVisibility", "./KeyCodes", "./keyboard"], function (require, exports, React, react_1, useFocusRects_1, FocusRectsProvider_1, setFocusVisibility_1, KeyCodes_1, keyboard_1) {
    "use strict";
    ...
    describe('useFocusRects', function () {
        ...
        describe('when attaching the classnames to the window body', function () {
            it('can hint to show focus when you press a directional key', function () {
                (0, react_1.act)(function () {
                    focusRects1 = (0, react_1.render)(React.createElement(useFocusRects_1.FocusRects, { rootRef: mockRefObject }));
                    focusRects2 = (0, react_1.render)(React.createElement(useFocusRects_1.FocusRects, { rootRef: mockRefObject }));
                });
            ...
            it('can hint to show focus when you press a directional key with multi-window', function () {
                (0, react_1.act)(function () {
                    focusRects1 = (0, react_1.render)(React.createElement(useFocusRects_1.FocusRects, { rootRef: mockRefObject }));
                    focusRects2 = (0, react_1.render)(React.createElement(useFocusRects_1.FocusRects, { rootRef: mockRefObject2 }));
                });
            ...
            it('can disable focus rects', function () {
                ...
                var component;
                (0, react_1.act)(function () {
                    component = (0, react_1.render)(React.createElement(useFocusRects_1.FocusRects, { rootRef: mockRefObject }));
                });
                var eventListeners = mockWindow.eventListeners;
        ...
        describe('when attaching the classnames to the a provider element', function () {
            ...
            it('can hint to show focus when you press a directional key', function () {
                ...
                (0, react_1.act)(function () {
                    focusRects1 = (0, react_1.render)(React.createElement(FocusRectsWithProvider, { providerRef: providerRef, rootRef: mockRefObject }));
                });
            ...
            it('can disable focus rects', function () {
                ...
                var component;
                (0, react_1.act)(function () {
                    component = (0, react_1.render)(React.createElement(FocusRectsWithProvider, { providerRef: providerRef, rootRef: mockRefObject }));
                });
                var providerElem = providerRef.current;
                var eventListeners = providerElem.eventListeners;
                expect(eventListeners.keyup).toBeUndefined();
