define(["require", "exports", "react", "@testing-library/react", "./useFocusRects", "./setFocusVisibility", "./dom/getWindow"], function (require, exports, React, react_1, useFocusRects_1, setFocusVisibility_1, getWindow) {
    "use strict";
    ...
    describe('setFocusVisibility', function () {
        ...
        beforeEach(function () {
            ...
            classNames = [];
            component = (0, react_1.render)(React.createElement(useFocusRects_1.FocusRects, null));
        });
