...
public sealed class TableUpdater
{
    ...
    public void AppendVersionHistory(WordprocessingDocument templateDoc, string? author)
    {
        ...
        if (templateRow != null)
        {
            ...
            if (cells.Count >= 1) SetCellText(cells[0], "1.0");
            ...
            if (cells.Count >= 4) SetCellText(cells[3], "Autogenerated by Merge API");
    ...
    public void AppendChangeLog(WordprocessingDocument templateDoc, string? author)
    {
        ...
        if (templateRow != null)
        {
            ...
            if (cells.Count >= 1) SetCellText(cells[0], "1");
            if (cells.Count >= 2) SetCellText(cells[1], DateTime.UtcNow.ToString("yyyy-MM-dd HH:mm:ss 'UTC'"));
            if (cells.Count >= 3) SetCellText(cells[2], "Auto Merge");
            if (cells.Count >= 4) SetCellText(cells[3], "Document autogenerated via Merge API");
            if (cells.Count >= 5) SetCellText(cells[4], string.IsNullOrWhiteSpace(author) ? "System Generated" : author!);
        }
        else
        {
            newRow = new TableRow();
            newRow.Append(Cells("1",
                                DateTime.UtcNow.ToString("yyyy-MM-dd HH:mm:ss 'UTC'"),
                                "Auto Merge",
                                "Document autogenerated via Merge API",
                                string.IsNullOrWhiteSpace(author) ? "System Generated" : author!));
        }
